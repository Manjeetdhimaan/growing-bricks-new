...
/*----------------------------------------------------
Close Memnu on body Click 
------------------------------------------------------*/

$(document).on('click', 'body *', function (e) {
    var RemovemenuToggle = $('a.open-menu-toggle'),
      RemovelogoToggle = $('div.logo'),
      RemovemenuList = $('nav.nav-menu-box'),
      RemovesocialLine = $('.social-line');
    // Check if click was triggered on or within #menu_content
    if ($(e.target).closest("header.clearfix").length > 0) {

    }
    else {
        if ($('a.open-menu-toggle').hasClass("active")) {
            RemovemenuToggle.removeClass('active');
            RemovelogoToggle.removeClass('active');
            RemovemenuList.removeClass('active');
            RemovesocialLine.removeClass('active');
        }
    }
});
...
/*----------------------------------------------------
Open Enquiry Popup after 30 Second
------------------------------------------------------*/
...
/*----------------------------------------------------
Close Enquiry Popup OnClick
------------------------------------------------------*/

$(".close-div-popup").on('click', function (event) {
    $(".backgroundOverlay").addClass("ClosePopup");
    $(".form-section-main").addClass("ClosePopup");
    $(".backgroundOverlay").removeClass("ShowPopup");
    $(".form-section-main").removeClass("ShowPopup");
...
/*----------------------------------------------------
Open Enquiry Popup OnClick Desktop
------------------------------------------------------*/
...
/*----------------------------------------------------
Open Enquiry Popup OnClick Mobile
------------------------------------------------------*/

$(".info-box-m").on('click', function (event) {
    $(".backgroundOverlay").addClass("ShowPopup");
    $(".form-section-main").addClass("ShowPopup");
    $(".backgroundOverlay").removeClass("ClosePopup");
    $(".form-section-main").removeClass("ClosePopup");
