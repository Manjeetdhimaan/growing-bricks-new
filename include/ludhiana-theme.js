...
$(document).ready(function ($) {
    "use strict";
	 ...
	 $("#header").load("../include/ludhiana-header.html");
     $("#top-call-section").load("../include/ludhiana-top-header.html");
	 $("#top-menu-section").load("../include/ludhiana-top-menu.html");
	 $("#footer").load("../include/ludhiana-footer.html");	
    ...
    if (message == "Good Morning" ||message =="Good Afternoon"){
        ...
        //$(".headerlogomohaliphase2").attr("src", "../images/projects/herohomes-logo-ludhiana-b.png");
        ...
        //$(".headerlogomohaliphase2").attr("src", "../images/projects/herohomes-logo-ludhiana-w.png");
