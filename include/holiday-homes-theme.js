...
$(document).ready(function ($) {
    "use strict";
	 ...
	 $("#header").load("../../include/holiday-homes-header.html");
	 $("#top-call-section").load("../../include/holiday-homes-top-header.html");
	 $("#top-menu-section").load("../../include/holiday-homes-top-menu.html");
	 $("#footer").load("../../include/holiday-homes-footer.html");
