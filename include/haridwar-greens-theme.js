...
$(document).ready(function ($) {
    ...
    $("#header").load("../../include/haridwar-greens-header.html");
    $("#top-call-section").load("../../include/haridwar-greens-top-header.html");
    $("#top-menu-section").load("../../include/haridwar-greens-top-menu.html");
    $("#footer").load("../../include/haridwar-greens-footer.html");
    ...
    if (message == "Good Morning" ||message =="Good Afternoon"){
        ...
        //$(".headerlogomohaliphase2").attr("src", "../../images/projects/herohomes-logo-haridwar-b.png");      
        ...
        //$(".headerlogomohaliphase2").attr("src", "../../images/projects/herohomes-logo-haridwar-w.png");
...
const onload = () => {
    const icon = document.querySelector(".info-box2 .fa-sun");
    var ndate = new Date();
    var hours = ndate.getHours();
    var message = hours < 12 ? 'Good Morning' : hours < 18 ? 'Good Afternoon' : 'Good Evening';
    if (icon) {
...
function Validate() {
    ...
    var txtSubject = "Haridwar Greens"
