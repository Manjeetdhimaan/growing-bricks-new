...
$(document).ready(function ($) {
    "use strict";
	 ...
	 $("#header").load("../../include/gharaunda-header.html");
	 $("#top-call-section").load("../../include/gharaunda-top-header.html");
	 $("#top-menu-section").load("../../include/gharaunda-top-menu.html");
	 $("#footer").load("../../include/gharaunda-footer.html");
...
function Validate() {
    ...
    var txtSubject = "Gharaunda - Haridwar"
