...
$(document).ready(function ($) {
    "use strict";
	 ...
	 $("#header").load("../../include/alaknanda-header.html");
     $("#top-call-section").load("../../include/alaknanda-top-header.html");
	 $("#top-menu-section").load("../../include/alaknanda-top-menu.html");
	 $("#footer").load("../../include/alaknanda-footer.html");	
    var Theme = getCookie("Theme");
    $(".backgroundOverlay").hide();
    $(".form-section-main").hide();
    var ndate = new Date();
