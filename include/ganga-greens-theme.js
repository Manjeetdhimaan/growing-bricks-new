...
$(document).ready(function ($) {
    "use strict";
	 ...
	 $("#header").load("../../include/ganga-greens-header.html");
     $("#top-call-section").load("../../include/ganga-greens-top-header.html");
	 $("#top-menu-section").load("../../include/ganga-greens-top-menu.html");
	 $("#footer").load("../../include/ganga-greens-footer.html");	
...
function Validate() {
    ...
    var txtSubject = "Ganga Greens - Haridwar"
