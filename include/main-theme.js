...
$(document).ready(function ($) {
    "use strict";
	  $("#header").load("include/main-header.html");
	  $("#haridwar-header").load("include/haridwar-header.html");
      $("#top-call-section").load("include/main-top-header.html");
	  $("#footer").load("include/main-footer.html");	 
    ...
    if (message == "Good Morning" || message == "Good Afternoon") {
		...
		$('link[name="darkcontact"]').attr("disabled", "disabled");
        $('link[name="lightcontact"]').removeAttr("disabled", "disabled");
		...
		$('link[name="aboutus_darkview"]').attr("disabled", "disabled");
        $('link[name="aboutus_lightview"]').removeAttr("disabled", "disabled");
      ...
      //  $("#changetheme").find($(".fa")).removeClass('fa-sun').addClass('fa-moon')
		...
		$('link[name="lightcontact"]').attr("disabled", "disabled");
        $('link[name="darkcontact"]').removeAttr("disabled", "disabled");		
		...
		$('link[name="aboutus_lightview"]').attr("disabled", "disabled");
        $('link[name="aboutus_darkview"]').removeAttr("disabled", "disabled");
