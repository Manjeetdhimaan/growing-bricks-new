...
$(document).ready(function ($) {
    ...
    $("#header").load("../../include/utkarsh-header.html");
	 $("#top-call-section").load("../../include/utkarsh-top-header.html");
	 $("#top-menu-section").load("../../include/utkarsh-top-menu.html");
	 $("#footer").load("../../include/utkarsh-footer.html");
