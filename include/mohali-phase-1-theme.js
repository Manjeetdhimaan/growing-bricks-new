...
$(document).ready(function ($) {
    "use strict";
	 ...
	 $("#header").load("../../include/mohali-phase-1-header.html");
     $("#top-call-section").load("../../include/mohali-phase-1-top-header.html");
	 $("#top-menu-section").load("../../include/mohali-phase-1-top-menu.html");
	 $("#footer").load("../../include/mohali-phase-1-footer.html");	
    ...
    if (message == "Good Morning" ||message =="Good Afternoon"){
        ...
        //$(".headerlogomohaliphase2").attr("src", "../../images/projects/herohomes-logo-mohali-phase1-b.png");      
        ...
        //$(".headerlogomohaliphase2").attr("src", "../../images/projects/herohomes-logo-mohali-phase1-w.png");
