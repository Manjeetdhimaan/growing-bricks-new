...
$(document).ready(function ($) {
    "use strict";
	 ...
	 $("#header").load("../include/gurugram-header.html");
     $("#top-call-section").load("../include/gurugram-top-header.html");
	 $("#top-menu-section").load("../include/gurugram-top-menu.html");
	 $("#footer").load("../include/gurugram-footer.html");
    ...
    //if (Theme == "Light") {
        ...
        //$(".headerlogomohaliphase2").attr("src", "../images/projects/herohomes-logo-gurugram-b.png");
        ...
        //$(".headerlogomohaliphase2").attr("src", "../images/projects/herohomes-logo-gurugram-w.png");
